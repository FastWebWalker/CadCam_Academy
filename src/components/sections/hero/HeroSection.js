...
const HeroSection = ({ image }) => {
  ...
  const arrowAnimation = {
    ...
    animate: {
      ...
      y: 0,
      transition: {
        delay: 1.5, // Start after main content animations
        duration: 0.8,
      },
    },
    bounce: {
      ...
      transition: {
        ...
        repeat: Infinity,
        ease: "easeInOut",
        delay: 2.3, // Start bouncing after fade-in
      },
    },
  };
  ...
  return (
    <motion.section
      ...
      <div className="relative z-60 sm:pt-[12.1%] pt-[20%] lg:pb-[64px] md:pb-[122px] pb-[48px]">
        ...
        {/* Animated Arrow */}
        <motion.div
          className="absolute lg:bottom-[-3%] bottom-[-3%] right-[2vw] md:bottom-[-3%] md:w-[13.88vw] md:h-[13.88vw] w-[30vw] h-[30vw] bg-transparent border-[1px] border-[#C7C7C7] flex items-center justify-center rounded-full"
          initial="initial"
          animate={hasAnimated ? ["animate", "bounce"] : "initial"}
          variants={arrowAnimation}>
          <motion.img src={arrowDown} alt="arrow-down" />
        </motion.div>
      </div>
    </motion.section>
  );
